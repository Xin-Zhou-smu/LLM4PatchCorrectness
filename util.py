...
def prepro_sentence_pair_single(ids1, ids2, max_length,
    ...
    # """ append at front """
    # input_ids = [pad_token_id for _ in range(n_mask)] + ids1 + ids2
...
def get_prompts(task, idx):
    ...
    if task in ['patch_HP', 'patch_Developer','patch_bear', 'patch_ACS',  'patch_Arja',  'patch_AVATAR',  'patch_CapGen',  'patch_Cardumen',  'patch_DynaMoth',  'patch_FixMiner',  'patch_GenProg',  'patch_HDRepair',  'patch_Jaid',  'patch_jGenProg',  'patch_jKali',  'patch_jMutRepair',  'patch_Kali',  'patch_kPAR',  'patch_Nopol',  'patch_RSRepair',  'patch_SequenceR',  'patch_SimFix' ,'patch_SketchFix',  'patch_SOFix',  'patch_TBar']:
        # templates = ["\n Q: It was wrong or correct? A: It was %s", "Q: The Code is wrong or correct? A: The Code is %s", "Q: wrong or correct? A: A %s one", "Q: wrong or correct? A: A %s code","All in all %s", "Test Defect: %s"]
        ...
        # templates = ["was %s."]
        # templates = ["It was %s."]
        #templates = ["wrong or correct? It was %s."]
        # templates = ["It was %s . ", "The Code is %s .", "A %s one . ", "A %s code . ",
                     # "All in all %s . ",   "Test Defect: %s"]
    ...
    if task in ['patch_HP','patch_Developer', 'patch_bear', 'patch_ACS',  'patch_Arja',  'patch_AVATAR',  'patch_CapGen',  'patch_Cardumen',  'patch_DynaMoth',  'patch_FixMiner',  'patch_GenProg',  'patch_HDRepair',  'patch_Jaid',  'patch_jGenProg',  'patch_jKali',  'patch_jMutRepair',  'patch_Kali',  'patch_kPAR',  'patch_Nopol',  'patch_RSRepair',  'patch_SequenceR',  'patch_SimFix' ,'patch_SketchFix',  'patch_SOFix',  'patch_TBar']:
        #label_words = ["correct", "overfitting"]
        label_words = ["correct", "wrong"]
        # label_words = ["good", "bad"]
        # label_words = ["wrong","correct"]
        # label_words = ["correct patch, do not find any issues.", "wrong one, found bugs."]
